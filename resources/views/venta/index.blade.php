    ...
    <div class="container-fluid px-4">
        ...
        @can('crear-venta')
            <div class="mb-4">
                ...
                <a href="{{ route('venta.pdf') }}" class="btn btn-primary" target="_blank">Generar reporte en pdf</a>
                <a href="{{ route('venta.reporte') }}" class="btn btn-primary" target="_blank">Ver reporte</a>
